...
После сида будут созданы языки (ru, en, kk), типы меню (Основное, Барное, Чайная карта, Винная карта, Детское) и пользователь админки: **admin@ayvan.local** / **admin123**.
...
В админке войти под admin@ayvan.local / admin123, заполнить меню на русском и при необходимости нажать «Перевести» для заполнения остальных языков (нужен `GEMINI_API_KEY`).
